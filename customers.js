document.addEventListener('DOMContentLoaded', function () {
  ...
  vegetarianToggle.addEventListener('click', function () {
    ...
    localStorage.setItem('vegetarianChecked', vegetarianCheckbox.checked);
    console.log("Vegetarian filter toggled:", vegetarianCheckbox.checked);
  ...
  glutenToggle.addEventListener('click', function () {
    ...
    localStorage.setItem('glutenFreeChecked', glutenCheckbox.checked);
  ...
  organicToggle.addEventListener('click', function () {
    ...
    localStorage.setItem('organicChecked', organicCheckbox.checked);
